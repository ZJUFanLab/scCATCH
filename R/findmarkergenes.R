...
#' @param object Seurat object (>= 3.0.0) after log1p normalization and cluster analysis. Please ensure data is log1p normalized data and data has been clustered before running scCATCH pipeline.
