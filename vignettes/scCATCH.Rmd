...
scCATCH can be used to annotate scRNA-seq data from tissue with cancer and with cancer.

scCATCH can handle large single-cell transcriptomic dataset containing more than 10,000 cells and more than 15 clusters.
...
`object` 
Seurat object (>= 3.0.0) after log1p normalization and cluster analysis. <font color=red>Please ensure data is log1p normalized data and data has been clustered before running scCATCH pipeline.</font>
