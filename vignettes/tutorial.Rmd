...
```{r findmarkergene_custom, eval=FALSE, include=FALSE}
...
```{r findcelltype1, eval=FALSE, include=FALSE}
# Example
cellmatch <- cellmatch
cellmatch <- cellmatch[cellmatch$tissue %in% ("Liver", "Lung", "Brain"),]
obj <- findmarkergene(object = obj,if_use_custom_marker = T, marker = cellmatch)

# Example
cellmatch <- cellmatch
cellmatch <- cellmatch[cellmatch$cancer %in% ("Oligodendroglioma", "Astrocytoma", "CNS Primitive Neuroectodermal Tumor", "High-grade glioma"),]
obj <- findmarkergene(object = obj,if_use_custom_marker = T, marker = cellmatch)

# Example
cellmatch <- cellmatch
cellmatch <- cellmatch[cellmatch$cancer %in% ("Oligodendroglioma", "Astrocytoma", "CNS Primitive Neuroectodermal Tumor", "High-grade glioma") | cellmatch$tissue %in% ("Liver", "Lung", "Brain"),]
obj <- findmarkergene(object = obj,if_use_custom_marker = T, marker = cellmatch)

```

[2] Add more marker genes to `cellmatch` for annotation
```{r findcelltype2, eval=FALSE, include=FALSE}
# Example
cellmatch <- cellmatch
...
```{r findcelltype3, eval=FALSE, include=FALSE}
