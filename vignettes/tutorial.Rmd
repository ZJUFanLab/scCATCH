...
obj <- findmarkergene(object = obj, if_use_custom_marker = T, marker = cellmatch_new)
...
obj <- findmarkergene(object = obj, species = "Rat", if_use_custom_marker = T, marker = cellmatch_new, tissue = "Kidney")
obj <- findcelltype(obj)
```
